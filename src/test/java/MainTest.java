...
public class MainTest {
    ...
    * */
    ...
    private final static String REGEXP_WORDS_FIRST_CHAR_MAIUSC = "([A-Z])\\w+";
    ...
    private final static String[] REGEXP = {REGEXP_WORDS_FIRST_CHAR_MAIUSC,REGEXP_NUMBERS,REGEXP_HTML};
